...
public abstract class DynamicElementUtil {
    ...
    public static SelenideElement findAction(ObjectCriteria criteria, By selectAction, SelenideElement source) throws DynamicElementException {
    ...
    private static SelenideElement _findObjectWithActions(ActionCriteria criteria, SelenideElement source) {
        String xpath = criteria.getObjectCriteria().getXpath();
    ...
    private static SelenideElement _prepareSource(ActionCriteria criteria, SelenideElement source) {
        ...
        String objectName = criteria.getObjectCriteria().getIdentifier();
