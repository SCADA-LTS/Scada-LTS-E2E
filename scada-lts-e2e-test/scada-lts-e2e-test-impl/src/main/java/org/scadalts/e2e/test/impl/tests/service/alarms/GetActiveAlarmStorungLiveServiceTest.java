...
public class GetActiveAlarmStorungLiveServiceTest {
    ...
    public static void setup() {
        ...
        alarmsAndStorungsObjectsCreator =
                new AlarmsAndStorungsObjectsCreator(navigationPage, dataSourceCriteria, pointAlarm, pointStorung);
