...
public class CreateEventHandlerSubCommand implements SubCommand<EventHandlerCriteria> {
    ...
    private CreateEventHandlerSubCommand(@NonNull NavigationPage navigationPage, @NonNull EventDetectorCriteria eventDetectorCriteria, @NonNull ScriptCriteria scriptCriteria) {
