...
public class GetInactiveLivesAfterSeqServiceTest {
    ...
    public static List<TestDataBatch> data() {
        ...
        result.addAll(generateDataTestEndValue(1, DataPointNotifierType.ALARM, LoggingType.ALL, 0));
    ...
    public GetInactiveLivesAfterSeqServiceTest(TestDataBatch testDataBatch) {
    ...
    @Test
    public void test_when_set_sequence_then_inactive_live() {
