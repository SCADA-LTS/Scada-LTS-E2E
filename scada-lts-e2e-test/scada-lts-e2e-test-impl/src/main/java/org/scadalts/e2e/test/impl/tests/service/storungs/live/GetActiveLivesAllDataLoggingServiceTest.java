...
@Log4j2
public class GetActiveLivesAllDataLoggingServiceTest {
    ...
    public static void setup() {
        ...
        VirtualDataPointCriteria pointStorung = VirtualDataPointCriteria.noChangeAllDataLogging(storungIdentifier, "0");
