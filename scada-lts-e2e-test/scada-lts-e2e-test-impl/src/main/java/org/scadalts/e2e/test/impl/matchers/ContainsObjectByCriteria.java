...
public class ContainsObjectByCriteria extends TypeSafeMatcher<PageObject<?>> {

    private final CriteriaObject criteria;
    private PageObject<?> page;

    ContainsObjectByCriteria(CriteriaObject criteria) {
    ...
    public static ContainsObjectByCriteria containsObjectByCriteria(CriteriaObject criteria) {
        return new ContainsObjectByCriteria(criteria);
    }
}
