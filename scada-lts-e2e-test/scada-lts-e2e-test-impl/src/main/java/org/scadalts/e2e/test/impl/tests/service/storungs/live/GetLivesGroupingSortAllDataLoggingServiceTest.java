...
public class GetLivesGroupingSortAllDataLoggingServiceTest {
    ...
    public GetLivesGroupingSortAllDataLoggingServiceTest(int offset, int limit) {
        this.offset = offset;
        this.limit = limit;
    }
    ...
    public static void setup() {
        ...
        VirtualDataPointCriteria[] activeNotifierAlarams = Stream.of(activeIdnetifiers)
                .map(a -> VirtualDataPointCriteria.noChangeAllDataLogging(a, "1"))
